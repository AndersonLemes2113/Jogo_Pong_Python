...
def atualizar():
    ...
    if keys[K_w] and yDoJogador1 < ALTURA_JANELA / 2 - alturaDosJogadores() / 2:
        yDoJogador1 += 0.5

    if keys[K_s] and yDoJogador1 > - ALTURA_JANELA / 2 + alturaDosJogadores() / 2:
        yDoJogador1 -= 0.5

    if keys[K_UP] and yDoJogador2 < ALTURA_JANELA / 2 - alturaDosJogadores() / 2:
        yDoJogador2 += 0.5

    if keys[K_DOWN] and yDoJogador2 > - ALTURA_JANELA / 2 + alturaDosJogadores() / 2:
        yDoJogador2 -= 0.5
